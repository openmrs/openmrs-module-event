...
public class HibernateEventInterceptor_2_x extends HibernateEventInterceptorSuperClass {
	protected final Log log = LogFactory.getLog(HibernateEventInterceptor_2_x.class);
